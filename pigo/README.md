...
[![CI](https://github.com/hdm/facecrime/pigo/actions/workflows/ci.yml/badge.svg)](https://github.com/hdm/facecrime/pigo/actions/workflows/ci.yml)
[![go.dev reference](https://img.shields.io/badge/pkg.go.dev-reference-007d9c?logo=go)](https://pkg.go.dev/github.com/hdm/facecrime/pigo/core)
[![license](https://img.shields.io/github/license/esimov/pigo)](./LICENSE)
[![release](https://img.shields.io/badge/release-v1.4.5-blue.svg)](https://github.com/hdm/facecrime/pigo/releases/tag/v1.4.5)
...
Check out this example for a realtime demo: https://github.com/hdm/facecrime/pigo/tree/master/examples/puploc
...
Check out this example for a realtime demo: https://github.com/hdm/facecrime/pigo/tree/master/examples/facial_landmark
...
```bash
$ go install github.com/hdm/facecrime/pigo/cmd/pigo@latest
```

### Binary releases
In case you do not have installed or do not wish to install Go, you can obtain the binary file from the [releases](https://github.com/hdm/facecrime/pigo/releases) folder.
...
For more details check the subpage description: https://github.com/hdm/facecrime/pigo/tree/master/wasm.
...
```
The code used for the above test can be found under the following link: https://github.com/hdm/facecrime/pigo-gocv-benchmark
...
This software is distributed under the MIT license. See the [LICENSE](https://github.com/hdm/facecrime/pigo/blob/master/LICENSE) file for the full license text.
